    ...
    <section className="relative py-24 overflow-hidden">
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {agents.map((agent, i) => (
            <FadeIn key={agent.slug} delay={i * 0.15}>
                ...
                >
                  <div className="p-6">
                    ...
                    <div
                      ...
                      style={{ backgroundColor: `${agent.primaryColor}15`, color: agent.primaryColor }}
                    >
                      {agent.tone}
                    </div>
                    ...
                    <p className="text-sm text-slate-600 leading-relaxed mb-6 line-clamp-3">
                      "{agent.greeting.slice(0, 120)}..."
                    </p>

                    {/* CTA */}
                    <div className="flex items-center gap-2 text-sm font-semibold" style={{ color: agent.primaryColor }}>
